      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6">
          ...
          <div className="lg:col-span-6 flex flex-col space-y-4">
            ...
            <div className="flex items-center justify-between pt-4 max-w-md">
              <div className="flex items-center space-x-4 text-white/80">
                {/* Github SVG */}
                <a href="#" aria-label="Github" className="p-2.5 rounded-full border border-white/10 hover:bg-white/5 hover:text-white transition-colors">
                ...
                {/* LinkedIn SVG */}
                <a href="#" aria-label="Linkedin" className="p-2.5 rounded-full border border-white/10 hover:bg-white/5 hover:text-white transition-colors">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
                {/* Instagram SVG */}
                <a href="#" aria-label="Instagram" className="p-2.5 rounded-full border border-white/10 hover:bg-white/5 hover:text-white transition-colors">
                ...
                {/* Facebook SVG */}
                <a href="#" aria-label="Facebook" className="p-2.5 rounded-full border border-white/10 hover:bg-white/5 hover:text-white transition-colors">
              ...
              <button
                onClick={scrollToTop}
                className="inline-flex items-center gap-2 text-white border border-[#334155] bg-transparent px-4 py-2 rounded-full text-xs font-semibold uppercase tracking-wider transition-all hover:bg-[#1e293b] hover:border-[#475569]"
              >
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-[#94a3b8]">
          ...
          <p className="mt-2 sm:mt-0">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-white font-medium hover:underline">
             ismailcodes
            </a>.
          </p>
        </div>
