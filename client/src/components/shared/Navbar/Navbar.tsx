    ...
    <header className="w-full sticky top-0 z-50 bg-[#1c2d37] text-white shadow-md border-b border-white/10 font-sans">
      <Container>
        <div className="flex items-center justify-between h-20">
          ...
          {/* Desktop Right Side: Dynamic Auth (Login / Profile Avatar Only) */}
          ...
          <div className="lg:hidden flex items-center gap-3" ref={dropdownRef}>
            ...
            <button
              ...
              className="text-white p-2 focus:outline-none hover:text-gray-300 transition-colors cursor-pointer"
